...
public class Hooker
{
    ...
    private void AddScans()
    {
        ...
        // For DAT_142226bf6
        _scanner.ScanMany("LEA_140101809 and LEA_1401018a9",
            "48 8D 05 ?? ?? ?? ?? 80 3C ?? 01 74 ?? 41 B8 03 00 00 00 EB ?? 41 B8 02 00 00 00 EB ?? 41 B8 04 00 00 00 45 33 C9 48 8B D6 48 8B CF 48 8B 5C 24 ?? 48 8B 74 24 ?? 48 83 C4 20 5F E9 ?? ?? ?? ??",
            2, addresses =>
            {
        ...
        _scanner.ScanMany("CMP_140911e33 and CMP_1409257c3",
        ...
        _scanner.ScanMany("CMP_140911f4c and CMP_1409258dc",
            "41 80 BC ?? ?? ?? ?? ?? 02 0F 85 ?? ?? ?? ?? 41 0F B6 84 ?? ?? ?? ?? ?? E9 ?? ?? ?? ?? 41 83 78 ?? 01 0F 85 ?? ?? ?? ?? 41 0F B7 40 ?? 41 80 BC ?? ?? ?? ?? ?? 15 E9 ?? ?? ?? ?? 45 8B 48 ?? 41 8D 41 ?? 83 F8 01 0F 87 ?? ?? ?? ?? 41 8B 40 ?? 41 83 F9 02 75 ?? 0F B7 C8 E8 ?? ?? ?? ?? 4C 8B 45 ?? 48 8B 55 ?? 0F B7 C0 0F B7 C0 49 8D 8E ?? ?? ?? ?? 48 8D 0C ?? 48 85 C9 0F 84 ?? ?? ?? ?? 80 39 ?? 0F 85 ?? ?? ?? ?? 48 89 5D ?? 48 85 D2 75 ?? 48 8B 4D ?? 48 85 C9 75 ?? 4D 85 C0 0F 84 ?? ?? ?? ?? EB ?? 48 8B 45 ?? 48 89 42 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 55 ?? 48 89 51 ?? EB ?? 41 83 78 ?? 04 EB ?? 41 83 78 ?? 07 EB ?? 41 83 78 ?? 02 0F 85 ?? ?? ?? ?? 48 8B 45 ?? 48 89 5D ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 49 8B 00 BA 01 00 00 00 49 8B C8 FF 10 48 8B 4D ?? 48 8B 55 ?? 48 89 75 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B CE 48 8B D6 48 89 4D ?? 48 89 55 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 48 85 D2 75 ?? 48 85 C9 74 ?? EB ?? 48 89 4A ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 55 ?? 48 89 51 ?? 48 89 75 ?? 48 89 75 ?? 48 8B CF E8 ?? ?? ?? ?? B0 01 EB ?? 48 8B 45 ?? 48 89 5D ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 4D 85 C0 74 ?? 49 8B 00 BA 01 00 00 00 49 8B C8 FF 10 48 8B 4D ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? 48 89 48 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4D ?? 48 89 48 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B CF E8 ?? ?? ?? ?? 32 C0 4C 8B 74 24 ?? 48 8B 5C 24 ?? 48 8B 74 24 ?? 48 8B 7C 24 ?? 48 83 C4 40 5D C3",
            2, addresses =>
            {
        ...
        _scanner.ScanMany("LEA_1407f5a63 and LEA_1407f6d53",
            "48 8D 05 ?? ?? ?? ?? 44 38 24 ?? 0F 84 ?? ?? ?? ?? 48 8B 5D ?? 48 85 DB 0F 84 ?? ?? ?? ?? 48 8D 7B ?? 48 8B 1B 48 8D 44 24 ?? 48 3B F8 74 ?? 48 8B 45 ?? 48 39 47 ?? 74 ?? 48 8D 4C 24 ?? E8 ?? ?? ?? ?? EB ?? 48 8B 4C 24 ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4C 24 ?? 48 89 48 ?? 4C 89 65 ?? 4C 89 64 24 ?? 48 8B D7 48 8D 4C 24 ?? E8 ?? ?? ?? ?? 48 8B 45 ?? 4C 89 65 ?? 4C 89 6D ?? 48 85 C0 74 ?? 48 8D 4C 24 ?? 48 89 45 ?? 48 89 4D ?? 48 8D 4D ?? 48 89 48 ?? 48 8D 45 ?? 48 89 45 ?? EB ?? 48 8D 45 ?? 48 89 45 ?? 48 8D 44 24 ?? 48 89 45 ?? 48 8B 45 ?? 48 8D 55 ?? 49 8B CE 48 89 45 ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 85 DB 0F 85 ?? ?? ?? ?? 48 8B 55 ?? 48 8B 45 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 45 ?? 48 8B 55 ?? 48 89 75 ?? 48 85 D2 75 ?? 48 85 C0 74 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 4C 8B 44 24 ?? 48 8B 45 ?? 4C 89 6C 24 ?? 4D 85 C0 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 41 8D 50 ?? FF 10 48 8B 45 ?? 4C 8B 44 24 ?? 4C 89 65 ?? EB ?? 49 89 40 ?? 48 8B 45 ?? 48 85 C0 74 ?? 4C 8B 44 24 ?? 4C 89 40 ?? 49 8B C4 4C 89 64 24 ?? 48 89 45 ?? 4D 8B C4 48 89 74 24 ?? 4D 85 C0 75 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 4C 89 40 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 49 89 40 ?? 48 8B 45 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 4C 8B 44 24 ?? 4C 89 40 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 0F 57 C0 4C 89 6D ?? 48 8D 53 ?? 4C 89 65 ?? 48 8D 4D ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8D 55 ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 84 C0 0F 84 ?? ?? ?? ?? 48 8B 55 ?? 48 8B 45 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 45 ?? 48 8B 55 ?? 48 89 75 ?? 48 85 D2 75 ?? 48 85 C0 74 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 54 24 ?? 48 8B 45 ?? 4C 89 6C 24 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 48 8B 45 ?? 48 8B 54 24 ?? 4C 89 65 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 54 24 ?? 48 89 50 ?? 49 8B C4 49 8B D4 48 89 45 ?? 48 89 54 24 ?? 48 89 74 24 ?? 48 85 D2 75 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 48 89 50 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 54 24 ?? 48 89 50 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 48 8B 7D ?? BE 00 00 00 80 48 85 FF 0F 84 ?? ?? ?? ?? 4C 8D 35 ?? ?? ?? ?? 48 8D 5F ?? 48 8B 3F 48 8D 44 24 ?? 48 3B D8 74 ?? 48 8B 45 ?? 48 39 43 ?? 74 ?? 48 8D 4C 24 ?? E8 ?? ?? ?? ?? EB ?? 48 8B 4C 24 ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4C 24 ?? 48 89 48 ?? 4C 89 65 ?? 4C 89 64 24 ?? 48 8B D3 48 8D 4C 24 ?? E8 ?? ?? ?? ?? 48 8B 45 ?? 4C 89 65 ?? 4C 89 6D ?? 48 85 C0 74 ?? 48 8D 4C 24 ?? 48 89 45 ?? 48 89 4D ?? 48 8D 4D ?? 48 89 48 ?? 48 8D 45 ?? 48 89 45 ?? EB ?? 48 8D 45 ?? 48 89 45 ?? 48 8D 44 24 ?? 48 89 45 ?? 48 8B 45 ?? 48 8D 4D ?? 0F 57 C0 48 89 45 ?? 49 8B D7 4C 89 6D ?? F3 0F 7F 45 ?? 4C 89 65 ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 49 8B 57 ?? 48 8D 4D ?? 0F 57 C0 4C 89 75 ?? 48 83 C2 40 4C 89 65 ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8B 55 ?? 4C 8D 0D ?? ?? ?? ?? 0F 57 C0 4C 89 4D ?? 48 83 C2 18 4C 89 65 ?? 48 8D 4D ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8B 4D ?? 48 8B 55 ?? 48 8B 41 ?? 8B 58 ?? 48 8B 45 ?? 4C 89 4D ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 01 BA 01 00 00 00 FF 10 48 8B 45 ?? 48 8B 4D ?? 4C 89 65 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 49 8B C4 49 8B CC 48 89 45 ?? 48 89 4D ?? 48 8D 15 ?? ?? ?? ?? 48 89 55 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4D ?? 48 89 48 ?? 4C 89 65 ?? 4C 89 65 ?? 48 8D 4D ?? 4C 89 75 ?? E8 ?? ?? ?? ?? 48 8B 4D ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4D ?? 48 89 48 ?? 3B DE 7E ?? 48 8B 45 ?? 48 8D 4D ?? 48 39 45 ?? 74 ?? E8 ?? ?? ?? ?? EB ?? E8 ?? ?? ?? ?? 48 8D 54 24 ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 8B F3 48 85 FF 0F 85 ?? ?? ?? ?? 4C 8B 75 ?? 0F 57 C0 4C 89 6D ?? 48 8D 55 ?? 4C 89 65 ?? 48 8D 4D ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8D 55 ?? 49 8B CE E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 8D 4C 24 ?? E8 ?? ?? ?? ?? 48 8D 05 ?? ?? ?? ?? 48 8D 4D ?? 48 89 45 ?? E8 ?? ?? ?? ?? 49 8B CF E8 ?? ?? ?? ?? 4C 8D 9C 24 ?? ?? ?? ?? B0 01 49 8B 5B ?? 49 8B 73 ?? 49 8B 7B ?? 49 8B E3 41 5F 41 5E 41 5D 41 5C 5D C3",
            2, addresses =>
            {
                _LEA_1407f5a63_Address = addresses[0];
                _LEA_1407f6d53_Address = addresses[1];
            });
        _scanner.Scan("LEA_1407f6223",
            "48 8D 05 ?? ?? ?? ?? 44 38 24 ?? 0F 84 ?? ?? ?? ?? 48 8B 5D ?? 48 85 DB 0F 84 ?? ?? ?? ?? 48 8D 7B ?? 48 8B 1B 48 8D 44 24 ?? 48 3B F8 74 ?? 48 8B 45 ?? 48 39 47 ?? 74 ?? 48 8D 4C 24 ?? E8 ?? ?? ?? ?? EB ?? 48 8B 4C 24 ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4C 24 ?? 48 89 48 ?? 4C 89 65 ?? 4C 89 64 24 ?? 48 8B D7 48 8D 4C 24 ?? E8 ?? ?? ?? ?? 48 8B 45 ?? 4C 89 65 ?? 4C 89 6D ?? 48 85 C0 74 ?? 48 8D 4C 24 ?? 48 89 45 ?? 48 89 4D ?? 48 8D 4D ?? 48 89 48 ?? 48 8D 45 ?? 48 89 45 ?? EB ?? 48 8D 45 ?? 48 89 45 ?? 48 8D 44 24 ?? 48 89 45 ?? 48 8B 45 ?? 48 8D 55 ?? 49 8B CE 48 89 45 ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 85 DB 0F 85 ?? ?? ?? ?? 48 8B 55 ?? 48 8B 45 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 45 ?? 48 8B 55 ?? 48 89 75 ?? 48 85 D2 75 ?? 48 85 C0 74 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 4C 8B 44 24 ?? 48 8B 45 ?? 4C 89 6C 24 ?? 4D 85 C0 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 41 8D 50 ?? FF 10 48 8B 45 ?? 4C 8B 44 24 ?? 4C 89 65 ?? EB ?? 49 89 40 ?? 48 8B 45 ?? 48 85 C0 74 ?? 4C 8B 44 24 ?? 4C 89 40 ?? 49 8B C4 4C 89 64 24 ?? 48 89 45 ?? 4D 8B C4 48 89 74 24 ?? 4D 85 C0 75 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 4C 89 40 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 49 89 40 ?? 48 8B 45 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 4C 8B 44 24 ?? 4C 89 40 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 0F 57 C0 4C 89 6D ?? 48 8D 53 ?? 4C 89 65 ?? 48 8D 4D ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8D 55 ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 84 C0 0F 84 ?? ?? ?? ?? 48 8B 55 ?? 48 8B 45 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 45 ?? 48 8B 55 ?? 48 89 75 ?? 48 85 D2 75 ?? 48 85 C0 74 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 54 24 ?? 48 8B 45 ?? 4C 89 6C 24 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 48 8B 45 ?? 48 8B 54 24 ?? 4C 89 65 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 54 24 ?? 48 89 50 ?? 49 8B C4 49 8B D4 48 89 45 ?? 48 89 54 24 ?? 48 89 74 24 ?? 48 85 D2 75 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 48 89 50 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 54 24 ?? 48 89 50 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 48 8B 7D ?? BE FF FF FF 7F 48 85 FF 0F 84 ?? ?? ?? ?? 4C 8D 35 ?? ?? ?? ?? 48 8D 5F ?? 48 8B 3F 48 8D 44 24 ?? 48 3B D8 74 ?? 48 8B 45 ?? 48 39 43 ?? 74 ?? 48 8D 4C 24 ?? E8 ?? ?? ?? ?? EB ?? 48 8B 4C 24 ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4C 24 ?? 48 89 48 ?? 4C 89 65 ?? 4C 89 64 24 ?? 48 8B D3 48 8D 4C 24 ?? E8 ?? ?? ?? ?? 48 8B 45 ?? 4C 89 65 ?? 4C 89 6D ?? 48 85 C0 74 ?? 48 8D 4C 24 ?? 48 89 45 ?? 48 89 4D ?? 48 8D 4D ?? 48 89 48 ?? 48 8D 45 ?? 48 89 45 ?? EB ?? 48 8D 45 ?? 48 89 45 ?? 48 8D 44 24 ?? 48 89 45 ?? 48 8B 45 ?? 48 8D 4D ?? 0F 57 C0 48 89 45 ?? 49 8B D7 4C 89 6D ?? F3 0F 7F 45 ?? 4C 89 65 ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 49 8B 57 ?? 48 8D 4D ?? 0F 57 C0 4C 89 75 ?? 48 83 C2 40 4C 89 65 ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8B 55 ?? 4C 8D 15 ?? ?? ?? ??",
            address => _LEA_1407f6223_Address = address);
        _scanner.Scan("LEA_1407f83d3",
            "48 8D 05 ?? ?? ?? ?? 44 38 24 ?? 0F 84 ?? ?? ?? ?? 48 8B 5D ?? 48 85 DB 0F 84 ?? ?? ?? ?? 48 8D 7B ?? 48 8B 1B 48 8D 44 24 ?? 48 3B F8 74 ?? 48 8B 45 ?? 48 39 47 ?? 74 ?? 48 8D 4C 24 ?? E8 ?? ?? ?? ?? EB ?? 48 8B 4C 24 ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4C 24 ?? 48 89 48 ?? 4C 89 65 ?? 4C 89 64 24 ?? 48 8B D7 48 8D 4C 24 ?? E8 ?? ?? ?? ?? 48 8B 45 ?? 4C 89 65 ?? 4C 89 6D ?? 48 85 C0 74 ?? 48 8D 4C 24 ?? 48 89 45 ?? 48 89 4D ?? 48 8D 4D ?? 48 89 48 ?? 48 8D 45 ?? 48 89 45 ?? EB ?? 48 8D 45 ?? 48 89 45 ?? 48 8D 44 24 ?? 48 89 45 ?? 48 8B 45 ?? 48 8D 55 ?? 49 8B CE 48 89 45 ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 85 DB 0F 85 ?? ?? ?? ?? 48 8B 55 ?? 48 8B 45 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 45 ?? 48 8B 55 ?? 48 89 75 ?? 48 85 D2 75 ?? 48 85 C0 74 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 4C 8B 44 24 ?? 48 8B 45 ?? 4C 89 6C 24 ?? 4D 85 C0 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 41 8D 50 ?? FF 10 48 8B 45 ?? 4C 8B 44 24 ?? 4C 89 65 ?? EB ?? 49 89 40 ?? 48 8B 45 ?? 48 85 C0 74 ?? 4C 8B 44 24 ?? 4C 89 40 ?? 49 8B C4 4C 89 64 24 ?? 48 89 45 ?? 4D 8B C4 48 89 74 24 ?? 4D 85 C0 75 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 4C 89 40 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 49 89 40 ?? 48 8B 45 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 4C 8B 44 24 ?? 4C 89 40 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 0F 57 C0 4C 89 6D ?? 48 8D 53 ?? 4C 89 65 ?? 48 8D 4D ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8D 55 ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 84 C0 0F 84 ?? ?? ?? ?? 48 8B 55 ?? 48 8B 45 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 45 ?? 48 8B 55 ?? 48 89 75 ?? 48 85 D2 75 ?? 48 85 C0 74 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 54 24 ?? 48 8B 45 ?? 4C 89 6C 24 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 48 8B 45 ?? 48 8B 54 24 ?? 4C 89 65 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 54 24 ?? 48 89 50 ?? 49 8B C4 49 8B D4 48 89 45 ?? 48 89 54 24 ?? 48 89 74 24 ?? 48 85 D2 75 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 48 89 50 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 54 24 ?? 48 89 50 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 48 8B 7D ?? 41 8B F4",
        ...
        _scanner.Scan("LEA_1407f9ac3",
            "48 8D 05 ?? ?? ?? ?? 44 38 24 ?? 0F 84 ?? ?? ?? ?? 48 8B 5D ?? 48 85 DB 0F 84 ?? ?? ?? ?? 48 8D 7B ?? 48 8B 1B 48 8D 44 24 ?? 48 3B F8 74 ?? 48 8B 45 ?? 48 39 47 ?? 74 ?? 48 8D 4C 24 ?? E8 ?? ?? ?? ?? EB ?? 48 8B 4C 24 ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4C 24 ?? 48 89 48 ?? 4C 89 65 ?? 4C 89 64 24 ?? 48 8B D7 48 8D 4C 24 ?? E8 ?? ?? ?? ?? 48 8B 45 ?? 4C 89 65 ?? 4C 89 6D ?? 48 85 C0 74 ?? 48 8D 4C 24 ?? 48 89 45 ?? 48 89 4D ?? 48 8D 4D ?? 48 89 48 ?? 48 8D 45 ?? 48 89 45 ?? EB ?? 48 8D 45 ?? 48 89 45 ?? 48 8D 44 24 ?? 48 89 45 ?? 48 8B 45 ?? 48 8D 55 ?? 49 8B CE 48 89 45 ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 85 DB 0F 85 ?? ?? ?? ?? 48 8B 55 ?? 48 8B 45 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 45 ?? 48 8B 55 ?? 48 89 75 ?? 48 85 D2 75 ?? 48 85 C0 74 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 4C 8B 44 24 ?? 48 8B 45 ?? 4C 89 6C 24 ?? 4D 85 C0 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 41 8D 50 ?? FF 10 48 8B 45 ?? 4C 8B 44 24 ?? 4C 89 65 ?? EB ?? 49 89 40 ?? 48 8B 45 ?? 48 85 C0 74 ?? 4C 8B 44 24 ?? 4C 89 40 ?? 49 8B C4 4C 89 64 24 ?? 48 89 45 ?? 4D 8B C4 48 89 74 24 ?? 4D 85 C0 75 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 4C 89 40 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 49 89 40 ?? 48 8B 45 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 4C 8B 44 24 ?? 4C 89 40 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 0F 57 C0 4C 89 6D ?? 48 8D 53 ?? 4C 89 65 ?? 48 8D 4D ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8D 55 ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 84 C0 0F 84 ?? ?? ?? ?? 48 8B 55 ?? 48 8B 45 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 45 ?? 48 8B 55 ?? 48 89 75 ?? 48 85 D2 75 ?? 48 85 C0 74 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B 54 24 ?? 48 8B 45 ?? 4C 89 6C 24 ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 01 BA 01 00 00 00 FF 10 48 8B 45 ?? 48 8B 54 24 ?? 4C 89 65 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 54 24 ?? 48 89 50 ?? 49 8B C4 49 8B D4 48 89 45 ?? 48 89 54 24 ?? 48 89 74 24 ?? 48 85 D2 75 ?? 48 85 C0 0F 84 ?? ?? ?? ?? 48 89 50 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 54 24 ?? 48 89 50 ?? 4C 89 64 24 ?? 4C 89 65 ?? E9 ?? ?? ?? ?? 48 8B 7D ?? BE FF FF FF 7F 48 85 FF 0F 84 ?? ?? ?? ?? 4C 8D 35 ?? ?? ?? ?? 48 8D 5F ?? 48 8B 3F 48 8D 44 24 ?? 48 3B D8 74 ?? 48 8B 45 ?? 48 39 43 ?? 74 ?? 48 8D 4C 24 ?? E8 ?? ?? ?? ?? EB ?? 48 8B 4C 24 ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4C 24 ?? 48 89 48 ?? 4C 89 65 ?? 4C 89 64 24 ?? 48 8B D3 48 8D 4C 24 ?? E8 ?? ?? ?? ?? 48 8B 45 ?? 4C 89 65 ?? 4C 89 6D ?? 48 85 C0 74 ?? 48 8D 4C 24 ?? 48 89 45 ?? 48 89 4D ?? 48 8D 4D ?? 48 89 48 ?? 48 8D 45 ?? 48 89 45 ?? EB ?? 48 8D 45 ?? 48 89 45 ?? 48 8D 44 24 ?? 48 89 45 ?? 48 8B 45 ?? 48 8D 4D ?? 0F 57 C0 48 89 45 ?? 49 8B D7 4C 89 6D ?? F3 0F 7F 45 ?? 4C 89 65 ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 48 8D 4D ?? E8 ?? ?? ?? ?? 49 8B 57 ?? 48 8D 4D ?? 0F 57 C0 4C 89 75 ?? 48 83 C2 40 4C 89 65 ?? F3 0F 7F 45 ?? E8 ?? ?? ?? ?? 48 8B 55 ?? 4C 8D 0D ?? ?? ?? ??",
        ...
        // For DAT_142226c07
        _scanner.Scan("MOVZX_1400fa0d5",
            "42 0F B6 84 ?? ?? ?? ?? ?? FF C8 83 F8 0F 77 ?? 48 98 0F B6 84 ?? ?? ?? ?? ?? 8B 8C ?? ?? ?? ?? ?? 48 03 CA FF E1 42 80 BC ?? ?? ?? ?? ?? 01",
        ...
        _scanner.ScanForData("CALL_14091f24b for FUN_140911c80 for MOVZX_140911e42 and MOVZX_140911f5b",
            "E8 ?? ?? ?? ?? 84 C0 0F 84 ?? ?? ?? ?? B9 D6 00 00 00 E8 ?? ?? ?? ?? 83 F8 05 48 8B 45 ??",
            5, 1, 0, address =>
            {
                _MOVZX_140911e42_Address = address + 450;
                _MOVZX_140911f5b_Address = address + 731;
            });
        _scanner.ScanForData("CALL_140932186 for FUN_140925610 for MOVZX_1409257d2 and MOVZX_1409258eb",
            "E8 ?? ?? ?? ?? 84 C0 0F 84 ?? ?? ?? ?? B9 D6 00 00 00 E8 ?? ?? ?? ?? 83 F8 05 48 8B 85 ?? ?? ?? ??",
            5, 1, 0, address =>
            {
        ...
        _scanner.ScanMany("CMP_140911f79 and CMP_140925909",
            "41 80 BC ?? ?? ?? ?? ?? 15 E9 ?? ?? ?? ?? 45 8B 48 ?? 41 8D 41 ?? 83 F8 01 0F 87 ?? ?? ?? ?? 41 8B 40 ?? 41 83 F9 02 75 ?? 0F B7 C8 E8 ?? ?? ?? ?? 4C 8B 45 ?? 48 8B 55 ?? 0F B7 C0 0F B7 C0 49 8D 8E ?? ?? ?? ?? 48 8D 0C ?? 48 85 C9 0F 84 ?? ?? ?? ?? 80 39 ?? 0F 85 ?? ?? ?? ?? 48 89 5D ?? 48 85 D2 75 ?? 48 8B 4D ?? 48 85 C9 75 ?? 4D 85 C0 0F 84 ?? ?? ?? ?? EB ?? 48 8B 45 ?? 48 89 42 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 55 ?? 48 89 51 ?? EB ?? 41 83 78 ?? 04 EB ?? 41 83 78 ?? 07 EB ?? 41 83 78 ?? 02 0F 85 ?? ?? ?? ?? 48 8B 45 ?? 48 89 5D ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 49 8B 00 BA 01 00 00 00 49 8B C8 FF 10 48 8B 4D ?? 48 8B 55 ?? 48 89 75 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B CE 48 8B D6 48 89 4D ?? 48 89 55 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 48 85 D2 75 ?? 48 85 C9 74 ?? EB ?? 48 89 4A ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 55 ?? 48 89 51 ?? 48 89 75 ?? 48 89 75 ?? 48 8B CF E8 ?? ?? ?? ?? B0 01 EB ?? 48 8B 45 ?? 48 89 5D ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 4D 85 C0 74 ?? 49 8B 00 BA 01 00 00 00 49 8B C8 FF 10 48 8B 4D ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? 48 89 48 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4D ?? 48 89 48 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B CF E8 ?? ?? ?? ?? 32 C0 4C 8B 74 24 ?? 48 8B 5C 24 ?? 48 8B 74 24 ?? 48 8B 7C 24 ?? 48 83 C4 40 5D C3",
            2, addresses =>
            {
                _CMP_140911f79_Address = addresses[0];
                _CMP_140925909_Address = addresses[1];
            });
        _scanner.ScanMany("LEA_140911fb8 and LEA_140925948",
            "49 8D 8E ?? ?? ?? ?? 48 8D 0C ?? 48 85 C9 0F 84 ?? ?? ?? ?? 80 39 ?? 0F 85 ?? ?? ?? ?? 48 89 5D ?? 48 85 D2 75 ?? 48 8B 4D ?? 48 85 C9 75 ?? 4D 85 C0 0F 84 ?? ?? ?? ?? EB ?? 48 8B 45 ?? 48 89 42 ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 55 ?? 48 89 51 ?? EB ?? 41 83 78 ?? 04 EB ?? 41 83 78 ?? 07 EB ?? 41 83 78 ?? 02 0F 85 ?? ?? ?? ?? 48 8B 45 ?? 48 89 5D ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 49 8B 00 BA 01 00 00 00 49 8B C8 FF 10 48 8B 4D ?? 48 8B 55 ?? 48 89 75 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B CE 48 8B D6 48 89 4D ?? 48 89 55 ?? 48 8D 05 ?? ?? ?? ?? 48 89 45 ?? 48 85 D2 75 ?? 48 85 C9 74 ?? EB ?? 48 89 4A ?? 48 8B 4D ?? 48 85 C9 74 ?? 48 8B 55 ?? 48 89 51 ?? 48 89 75 ?? 48 89 75 ?? 48 8B CF E8 ?? ?? ?? ?? B0 01 EB ?? 48 8B 45 ?? 48 89 5D ?? 48 85 D2 75 ?? 48 85 C0 75 ?? 4D 85 C0 74 ?? 49 8B 00 BA 01 00 00 00 49 8B C8 FF 10 48 8B 4D ?? 48 8B 45 ?? 48 85 C9 75 ?? 48 85 C0 74 ?? 48 89 48 ?? EB ?? 48 89 41 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 4D ?? 48 89 48 ?? EB ?? 48 89 42 ?? 48 8B 45 ?? 48 85 C0 74 ?? 48 8B 55 ?? 48 89 50 ?? 48 8B CF E8 ?? ?? ?? ?? 32 C0 4C 8B 74 24 ?? 48 8B 5C 24 ?? 48 8B 74 24 ?? 48 8B 7C 24 ?? 48 83 C4 40 5D C3",
            2, addresses =>
            {
        ...
        _scanner.Scan("CMP_140d71d6a",
            "41 38 84 ?? ?? ?? ?? ?? 75 ?? 0F B7 CB E8 ?? ?? ?? ?? 0F BA E0 1E 72 ?? 0F B7 CB 8B D1 81 C1 00 A0 FF FF 48 C1 E9 05 83 E2 1F 41 8B 84 ?? ?? ?? ?? ?? 0F A3 D0 72 ??",
            address => _CMP_140d71d6a_Address = address);
        _scanner.Scan("CMP_140d72d0c",
            "41 38 84 ?? ?? ?? ?? ?? 75 ?? 0F B7 CB E8 ?? ?? ?? ?? 0F BA E0 1E 72 ?? 0F B7 CB 8B D1 81 C1 00 A0 FF FF 48 C1 E9 05 83 E2 1F 41 8B 84 ?? ?? ?? ?? ?? 0F A3 D0 73 ??",
        ...
        _scanner.ScanForData("CALL_14078f65d for FUN_140e3eb70 for LEA_140e3eb73",
            "E8 ?? ?? ?? ?? 41 0F B7 8F ?? ?? ?? ?? 48 8B D8 E8 ?? ?? ?? ?? 0F B6 0B 80 E9 0B 80 F9 0A 0F 86 ?? ?? ?? ??",
        ...
        _scanner.Scan("CMP_140d07c26",
            "80 BC ?? ?? ?? ?? ?? 00 0F 85 ?? ?? ?? ?? 48 8D 04 ?? 48 03 C0 0F B6 8C ?? ?? ?? ?? ?? 83 E9 01 74 ?? 83 F9 01 0F 85 ?? ?? ?? ?? 41 BE 1C 01 00 00",
        ...
        _scanner.Scan("CMP_14177b599",
            "80 BC ?? ?? ?? ?? ?? 00 0F 85 ?? ?? ?? ?? 48 8D 04 ?? 48 03 C0 0F B6 8C ?? ?? ?? ?? ?? 83 E9 01 74 ?? 83 F9 01 0F 85 ?? ?? ?? ?? BF 1C 01 00 00",
    ...
    public unsafe void CreateHooks(byte* pSkillElements, byte* pActiveSkillData, byte* pTechnicalComboMaps, uint skillSlotCount, uint technicalComboMapsCount)
    {
        _memory = new(Process.GetCurrentProcess());
        
        _skillElementsOffset = (long)pSkillElements - _DAT_142260b80_Address;
        _activeSkillDataOffset = (long)pActiveSkillData - _DAT_142226bf0_Address;
        _technicalComboMapsOffset = (long)pTechnicalComboMaps - _DAT_1422301f0_Address;
        
        // Segment 1
        _customInstructionSetPointer = (long)pActiveSkillData;
        _customInstructionSetOffset = _activeSkillDataOffset;
        
        // For DAT_142226bf0
        CreateHook(_LEA_140105ab5_Address, [
            "use64",
            $"mov r10, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_14071bd02_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_1407521d7_Address, [
            "use64",
            $"mov rcx, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_140753af8_Address, [
            "use64",
            $"mov r15, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_140753dfd_Address, [
            "use64",
            $"mov r13, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_1407b9128_Address, [
            "use64",
            $"mov rbx, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_140acd6f0_Address, [
            "use64",
            $"mov r14, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_140ad4414_Address, [
            "use64",
            $"mov rdx, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_140d6b75a_Address, [
            "use64",
            $"mov r12, {(ulong)pActiveSkillData}"
        ]);
        ...
        CreateHook(_LEA_140b110f8_Address, [
            "use64",
            $"mov r11, {(ulong)pActiveSkillData + 4}"
        ]);
        ...
        CreateHook(_LEA_140e2bc7f_Address, [
            "use64",
            $"mov rcx, {(ulong)pActiveSkillData + 4}"
        ]);
        
        CreateHook(_LEA_14bc3c1d9_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData + 4}"
        ]);
        
        // For DAT_142226bf6
        CreateHook(_LEA_140101809_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData + 6}"
        ]);
        ...
        CreateHook(_LEA_14171e63b_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData + 7}"
        ]);
        ...
        CreateHook(_LEA_1407b8b36_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData + 12}"
        ]);
        ...
        CreateHook(_LEA_1407ecfc0_Address, [
            "use64",
            $"mov rbx, {(ulong)pActiveSkillData + 12}"
        ]);
        ...
        CreateHook(_LEA_1407ed9e6_Address, [
            "use64",
            $"mov r8, {(ulong)pActiveSkillData + 12}"
        ]);
        ...
        CreateHook(_LEA_1407ee1dd_Address, [
            "use64",
            $"mov rdx, {(ulong)pActiveSkillData + 12}"
        ]);
        ...
        CreateHook(_LEA_1407f9327_Address, [
            "use64",
            $"mov rcx, {(ulong)pActiveSkillData + 12}"
        ]);
        ...
        CreateHook(_LEA_140ad5841_Address, [
            "use64",
            $"mov rcx, {(ulong)pActiveSkillData + 13}"
        ]);
        ...
        CreateHook(_LEA_140b764d7_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData + 13}"
        ]);
        ...
        CreateHook(_LEA_1407ba233_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData + 16}"
        ]);
        ...
        CreateHook(_LEA_14080e0c4_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData + 32}"
        ]);
        ...
        CreateHook(_LEA_140ad7871_Address, [
            "use64",
            $"mov rax, {(ulong)pActiveSkillData + 36}"
        ]);
        ...
        // Segment 0
        _customInstructionSetPointer = (long)pSkillElements;
        ...
        _memory.Write((UIntPtr)_LiteralReplacement_14080093d_Address + 1, skillSlotCount - 1);
        
        CreateHook(_LiteralReplacement_140801ec9_Address, [
            "use64",
            $"mov ecx, {skillSlotCount - 1}"
        ], AsmHookBehaviour.ExecuteAfter);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140802097_Address + 1, skillSlotCount - 1);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140800b29_Address + 1, skillSlotCount - 1);
        
        _memory.Write((UIntPtr)_LiteralReplacement_1407ba0c1_Address + 1, skillSlotCount - 1);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140764905_Address + 1, skillSlotCount - 1);
        
        CreateHook(_LiteralReplacement_1408073f8_Address, [
            "use64",
            $"mov r9d, {skillSlotCount - 1}"
        ], AsmHookBehaviour.ExecuteAfter);
        ...
        _memory.Write((UIntPtr)_LiteralReplacement_14080988e_Address + 1, skillSlotCount - 1);
        ...
        _memory.Write((UIntPtr)_LiteralReplacement_140b3241f_Address + 1, skillSlotCount - 1);
        ...
        _memory.Write((UIntPtr)_LiteralReplacement_140b32ec1_Address + 1, skillSlotCount - 1);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140b744d1_Address + 1, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140b74c2e_Address + 1, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140e16e8b_Address + 2, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140fb3d45_Address + 1, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_14073e903_Address + 1, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_14073d3f4_Address + 1, skillSlotCount);
        
        CreateHook(_LiteralReplacement_1409f00b6_Address, [
            "use64",
            $"mov r12d, {skillSlotCount - 1}"
        ], AsmHookBehaviour.ExecuteAfter);
        ...
        CreateHook(_LiteralReplacement_140aedd0a_Address, [
            "use64",
            $"mov r11d, {skillSlotCount - 1}"
        ], AsmHookBehaviour.ExecuteAfter);
        
        CreateHook(_LiteralReplacement_140b110f2_Address, [
            "use64",
            $"mov r10d, {skillSlotCount - 1}"
        ], AsmHookBehaviour.ExecuteAfter);
        
        CreateHook(_LiteralReplacement_140d23a21_Address, [
            "use64",
            $"mov eax, {skillSlotCount - 2}"
        ], AsmHookBehaviour.ExecuteAfter);
        
        CreateHook(_LiteralReplacement_140d23a57_Address, [
            "use64",
            $"mov ecx, {skillSlotCount - 2}"
        ], AsmHookBehaviour.ExecuteAfter);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140d23af6_Address + 1, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140d6b831_Address + 1, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140d6b8e0_Address + 1, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140d6b9be_Address + 1, skillSlotCount);
        
        _memory.Write((UIntPtr)_LiteralReplacement_140d6baaa_Address + 1, skillSlotCount);
        
        CreateHook(_LiteralReplacement_140d6bd94_Address, [
            "use64",
            $"mov ecx, {skillSlotCount}"
        ], AsmHookBehaviour.ExecuteAfter);
        
        CreateHook(_LiteralReplacement_140d73e36_Address, [
            "use64",
            $"mov eax, {skillSlotCount}"
        ], AsmHookBehaviour.ExecuteAfter);
        
        CreateHook(_LiteralReplacement_140e2bc3b_Address, [
            "use64",
            $"mov edx, {skillSlotCount - 2}"
        ], AsmHookBehaviour.ExecuteAfter);
        ...
        // Segment 2
        _customInstructionSetPointer = (long)pTechnicalComboMaps;
        ...
        CreateHook(_MOVZX_14076f1fc_Address, [
            "use64",
            $"mov r14d, {technicalComboMapsCount}"
        ]);
        ...
        CreateHook(_MOVZX_140e33058_Address, [
            "use64",
            $"mov ebp, {technicalComboMapsCount}"
        ]);
